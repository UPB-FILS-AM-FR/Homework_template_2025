...
#define LcdDATA_DDR             DDR_LCD_LED
#define LcdDATA_PORT            PORT_LCD_LED
#define LcdDATA_PIN             PIN_LCD_LED

// Pinii de date ai LCD-ului
#define LcdD4                   LCD_D4_SW1
#define LcdD5                   LCD_D5
#define LcdD6                   LCD_D6_SW2
#define LcdD7                   LCD_D7_SW3


// Portul pe care conectam pinii de control ai LCD-ului
#define LcdCTRL_DDR             DDR_LCD_LED
#define LcdCTRL_PORT            PORT_LCD_LED
#define LcdCTRL_PIN             PIN_LCD_LED

#define LcdEN_DDR             DDR_LCD_EN
#define LcdEN_PORT            PORT_LCD_EN
// #define LcdEN_PIN             PIN_LCD_EN
...
// Controleaza pinul E
#define LCD_ENABLE()            do { LcdEN_PORT |=  _BV(LcdE); } while(0)
#define LCD_DISABLE()           do { LcdEN_PORT &= ~_BV(LcdE); } while(0)
